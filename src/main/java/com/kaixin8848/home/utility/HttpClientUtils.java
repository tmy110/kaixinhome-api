 ...
 * @date 2019年7月2日
 * 使用例如
 * private void sendCanteenList(List<Map<String,Object>> mapList) throws UnsupportedEncodingException {
 * Gson gson = new Gson();
 * String param = gson.toJson(mapList);
 * String path = CanteenScheduler.SYNCHRONIZED_CANTEEN_URL;
 * HttpClientUtils httpClientUtils = HttpClientUtils.getInstance();
 * String result = httpClientUtils.sendHttpPost(path,param);
